...
Save this output as you will need it later in this guide. 
...
Once you're logged in, you can view the routes by navigating to the `Networking > Routes` page on the left. 
