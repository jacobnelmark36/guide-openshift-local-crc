...
Using the cloud allows you to easily scale and manage your microservices in a high-availability setup.
...
If there's an existing JSON object, add the following key/value pair:
...
To learn more about testing insecure registries, check out the official https://docs.docker.com/registry/insecure/[Docker documentation]. 
--
...
When you to go this URL, the system properties that are taken from the `system` service are 
