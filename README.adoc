...
:page-description: Explore how to deploy microservices to Red Hat OpenShift using CodeReady Containers
...
Explore how to use CodeReady Containers to deploy microservices to Red Hat OpenShift. 
...
Red Hat CodeReady Containers is the quickest way to get started building OpenShift
clusters. It is designed to run on a local computer to simplify setup and
testing, and emulate the cloud development environment locally with all of the
tools needed to develop container-based applications. To read more about CodeReady Containers,
check out the https://access.redhat.com/documentation/en-us/red_hat_codeready_containers/1.0/html/getting_started_guide/getting-started-with-codeready-containers_gsg[official documentation].
...
[role="no_copy"]
----
export PATH="/Users/guidesbot@ibm.com/.bin/oc:$PATH"
